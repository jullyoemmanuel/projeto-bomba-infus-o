...
// PINOS USADOS: 4 ao 9 (display, porém estes bloqueiam outros), (22, 24, 26, 28, 38, 36, 34, 32, 30) (teclado), 44 (motor), 48 (buzzer), 49 (led)
...
void iniciarInfusao(){   // ACIONA MOTOR, MOSTRA TEMPO E VOLUME RESTANTE NO DISPLAY
  ...
  { 
    ...
    if(tecla == 'T'){         // Se botão de pausa for pressionado, pausa infusão
      botaoPausarInfusao();   // Pausa infusão
      continue;
    }  
...
void botaoPausarInfusao() {   // Pausar infusão 
